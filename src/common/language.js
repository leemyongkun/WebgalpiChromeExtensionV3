let MESSAGE = {
  KR: {
    ...
    DESCRIPTION: {
      ...
      D0012: "검색어 입력 후 엔터 (AND 검색)", //placeholder
      D0013: "등록순서로 정렬합니다.",
  ...
  EN: {
    BUTTON: {
      B0001: "Category Controll", //카테고리 편집 버튼명
      B0002: "Sign Out",
  ...
  JP: {
    ...
    DESCRIPTION: {
      ...
      D0004:
        "下位カテゴリから上位カテゴリへのDrag&DropでTree構造を自由に構成することができます。",
      D0005: "上位カテゴリ",
      D0006: "上位カテゴリ名を追加及び修正します。",
      D0007: "上位カテゴリがありません。",
      D0008: "下位カテゴリ",
      D0009: "下位カテゴリ名を追加及び修正します。",
      D0010: "上位カテゴリを選択していないか、下位カテゴリが存在しません。",
      D0011: "選択されたカテゴリからコンテンツのタイタル／本文を検索します。",
      D0012: "検索語入力後エンター (AND 検索)", //placeholder
      D0013: "登録順序でソートします。",
      D0014: "★ 表示コンテンツをフィルタリングします。",
      D0015: "Scrapingに失敗したコンテンツをフィルタリングします。",
      D0016: "ハイライトを表示します。",
      D0017:
        "ロックされたコンテンツです。<br />もう一度Scraping試しあてください。",
      D0018: "コンテンツをNEWタブで開きます。",
      D0019: "Facebookにコンテンツを共有します。",
      D0020: "コンテンツを削除します。",
      D0021:
        "サイトにアクセスし、好きなカラーでハイライティングをしてみてください。",
      D0022: "コンテンツの変換ができないサイトです。",
      D0023:
        "Scrapingに失敗した場合には、そのサイトに直接アクセスしてLockをオフにすることができます。",
      D0024:
        "※ 方法 : 'Newタブで開く' > ブラウザー上部に位置したWEBGALPIアイコンクリック > ",
      D0025: "GoogleDriveにバックアップを進めますか？",
      D0026: "簡単なDescriptionを入力してください。",
      D0027: "(E) yyyy年 MM月 dd日 a/p hh時 mm分 ss秒)",
      D0028: "リカバリー",
      D0029: "バックアップ情報",
      D0030: "カテゴリ情報",
      D0031: "カテゴリサイトを含む情報",
      D0032: `※ Progressはクロリングに対する完了可否であり、全てのデータはリカバリーされます。<br />
                  ※ private serviceのデーターを外部に流出を防ぐためです。<br />
                  ※ FAILが発生した場合は下のようであり、 Contents Viewから再びクロリングを試すことができます。`,
      D0033: "サイト情報",
      D0034: "Connection Timeoutが5秒超えた場合。",
      D0035: "これ以上Serviceをしない場合。",
      D0036: "Private Serviceの場合。（内部ネット） (外部から防がれたサイト)",
      D0037: "FAILの確認は'ALL CATEGORY'（ALL ITEMS）をクリックした後、",
      D0038: "をクリックすると確認ができます。",
      D0039: "ハイライト情報",
      D0040: "バックアップ／リカバリー",
      D0041: "バックアップ",
      D0042: "GoogleDriveにファイル形でバックアップされます。",
      D0043: "全てのデーターは暗号化されます。",
      D0044: "ファイル名／フォルダ名／ファイルの内容を変更しないでください。",
      D0045: "リカバリーの場合、既存のデーターは全部削除されます。",
      D0046:
        "現在のアカウントと一致しない場合には、リカバリーできませんのでご注意ください。",
      D0047: "削除",
      D0048: "※ Scrapingに失敗した件については保存しません。",
      D0049: "最大６つのカラーを指定できます。",
      D0050: "THEME設定",
      D0051: "ログアウト",
      D0052: "ログアウトしますか？",
      D0053: "検索キーワード",
      D0054: "一斉表示",
      D0055: "タブグループを削除しますか？",
      D0056: "開いている全てのタブを集めて管理します。",
      D0057: `選択したタグループを削除しますか？<br>(全てのタブ情報が削除されます。)`,
      D0058: "現在のタブを除いた全てのタブが閉じます。<br>",
      D0059: `<b>上位カテゴリにコンテンツを入れることができません。サブカテゴリを作成しようとしましょう。<br /><br />※ 10秒後、この表示が消えます。</b>`,
      D0060: "カテゴリ名を入力後エンター",
      D0061: "ゴルイン",
      D0062: "Googleのアカウント登録をしましたか？",
      D0063:
      ...
      D0067: "대쉬보드의 테마설정을 LIGHT/DARK로 변경합니다.",
      D0068: "ダッシュボードのテーマ設定をLIGHT / DARKに変更します。",
      D0069: "お好みの色のハイライトカラーを指定して使用してください。",
      D0070: "UPDATE",
      D0071: "改善及び機能追加",
      D0072: "Debugging",
      D0073:
        "最近、バックアップしたデーターがあります。<br/>リカバリーを進めますか？",
      D0074:
        "ハイライトができないでしょうか？<br>NAVERやDaum Blogのサイトの構造は少し特別です。<br>このページをモバイルバージョンに変換し、もう一度試してください。",
      D0075: "サイトを保存します。",
      D0076: "カテゴリを変更します。",
      D0077: "LOCKされたこのサイトに解除ができます。",
      D0078: "ダッシュボードに移動します。",
      D0079: "ブロックされたサイト",
      D0080: "このサイトではWEBGALPIを使用することができません。",
      D0081: "FacebookやTwitterはアップデート中です。",
      D0082: "処理しました。",
      D0083:
    ...
    SNACK: {
      ...
      S0009: "IMPORTしました。",
      S0010: "COLORを指定しました。",
      S0011: "COLOR指定は最大6つです。",
      S0012: "COLORを１つ以上指定しなければいけません。",
      S0013: "バックアップファイルを削除しました。",
      S0014: "カテゴリに保存しました。",
      S0015: "カテゴリ保存に失敗しました。もう一度試してください。",
