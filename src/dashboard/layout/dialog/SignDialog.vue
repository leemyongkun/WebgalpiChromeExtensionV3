  ...
  methods: {
    ...
    async registMember() {
      if (this.accountInfo !== null) {
        console.log("🔍 Registering member with accountInfo:", this.accountInfo);
        ...
        // 안전한 MAXID 처리
        if (!result || !Array.isArray(result) || result.length === 0 || !result[0] || result[0].MAXID === null || result[0].MAXID === undefined) {
          categoryNewId = 1;
