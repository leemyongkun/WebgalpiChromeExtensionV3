...
PreviewMode.prototype = {
  ...
  REGEXPS: {
    unlikelyCandidates: /banner|breadcrumbs|combx|comment|community|cover-wrap|disqus|extra|foot|legends|menu|modal|related|remark|replies|rss|shoutbox|sidebar|skyscraper|social|sponsor|supplemental|ad-break|agegate|pagination|pager|popup|yom-remote/i,
  ...
  _prepArticle: function(articleContent) {
    ...
    if (h2.length === 1) {
      ...
      if (
        Math.abs(lengthSimilarRate) < 0.5 &&
        (lengthSimilarRate > 0
          ? h2[0].textContent.includes(this._articleTitle)
  ...
  _grabArticle: function(page) {
    ...
    while (true) {
          ...
          if (this._hasSinglePInsideElement(node)) {
            ...
            this._forEachNode(node.childNodes, function(childNode) {
              if (
                ...
                p.className = "waf-readmode-styled";
      ...
      for (var i = 0; i < topCandidates.length; i++) {
        if (topCandidates[i].nodeName != "WAFFLEPEN") {
      ...
      if (isPaging) articleContent.id = "waf-readmode-content";
  ...
  _cleanStyles: function(e) {
    ...
    if (
      ...
      e.className !== "waf-readmode-styled"
    )
    ...
    while (cur !== null) {
      if (cur.nodeType === cur.ELEMENT_NODE) {
        ...
        if (cur.className !== "waf-readmode-styled")
  ...
  _appendNextPage: function(nextPageLink) {
    ...
    articlePage.id = "waf-readmode-page-" + this._curPageNum;
    ...
    doc.getElementById("waf-readmode-content").appendChild(articlePage);
