<template>
  <div class="v-app app">
    ...
    <div style="position: fixed; top: 10px; right: 10px; z-index: 9999;">
      <button @click="clearAllData" style="background: red; color: white; padding: 10px; border: none; border-radius: 4px; cursor: pointer;">
        🔄 데이터 초기화
      </button>
    </div>
  </div>
...
export default {
  ...
  async mounted() {
    console.log("DashboardApp mounted, methods available:", typeof this.initDashboard);
