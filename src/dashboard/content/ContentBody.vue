<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <div>
    <v-row>
      <v-col cols="3" class="overflow-y-auto pl-2 pr-2"
        ><!--:style="documentHeightStyle"-->

        <v-card flat :style="listPanelAreaHeightStyle">
          <v-card-text>
            <v-row>
                                ...
                                <v-list-item-content>
                                  ...
                                  >
                                    <v-icon
                                      ...
                                      v-if="
                                        item.CATEGORY_NAME !== 'NO_CATEGORY'
                                      "
                                      >mdi-folder-outline
                                    </v-icon>
                                    {{ item.CATEGORY_NAME }}
...
export default {
  ...
  data: () => ({
    ...
    listPanelAreaHeightStyle: "max-height: 400px;",
  ...
  methods: {
    ...
    getWindowHeight() {
      ...
      this.reviewAreaHeightStyle =
        "height: " + (document.documentElement.clientHeight - 226) + "px;";
      this.listAreaHeightStyle =
        "max-height: " + (document.documentElement.clientHeight - 190) + "px;";
      this.listPanelAreaHeightStyle =
        "height: " + (document.documentElement.clientHeight - 87) + "px;";
