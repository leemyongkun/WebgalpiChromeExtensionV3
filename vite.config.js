  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'contents/core/hl-core': resolve(__dirname, 'src/contents/core/hl-core.js'),
        'contents/application': resolve(__dirname, 'src/contents/application.js'),
        ...
        'contents/global/config': resolve(__dirname, 'src/contents/global/config.js'),
